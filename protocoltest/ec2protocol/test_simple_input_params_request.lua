...
test("Ec2SimpleInputParamsStrings", function()
    local input = {
        Foo = "val1",
        Bar = "val2",
    }
    ...
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&Foo=val1&Bar=val2]])
end)

test("Ec2SimpleInputParamsStringAndBooleanTrue", function()
    local input = {
        Foo = "val1",
        Baz = true,
    }
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&Foo=val1&Baz=true]])
end)

test("Ec2SimpleInputParamsStringsAndBooleanFalse", function()
    local input = {
        Baz = false,
    }
    local operation = schema.operation({
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&Baz=false]])
end)

test("Ec2SimpleInputParamsInteger", function()
    local input = {
        Bam = 10,
    }
    local operation = schema.operation({
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&Bam=10]])
end)

test("Ec2SimpleInputParamsFloat", function()
    local input = {
        Boo = 10.8,
    }
    local operation = schema.operation({
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&Boo=10.8]])
end)

test("Ec2SimpleInputParamsBlob", function()
    local input = {
        Qux = "value",
    }
    local operation = schema.operation({
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&Qux=dmFsdWU%3D]])
end)

test("Ec2Enums", function()
    local input = {
        FooEnum = "Foo",
    }
    local operation = schema.operation({
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&FooEnum=Foo]])
end)

test("Ec2Query", function()
    local input = {
        HasQueryName = "Hi",
    }
    local operation = schema.operation({
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&HasQueryName=Hi]])
end)

test("Ec2QueryIsPreferred", function()
    local input = {
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&HasQueryAndXmlName=Hi]])
end)

test("Ec2XmlNameIsUppercased", function()
    local input = {
        UsesXmlName = "Hi",
    }
    local operation = schema.operation({
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&UsesXmlName=Hi]])
end)

test("Ec2QueryNameDistinctFromXmlNameAndMemberName", function()
    local input = {
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&QueryName=value1&queryAndXmlName=value2&XmlNameOnly=value3]])
end)

test("Ec2QuerySupportsNaNFloatInputs", function()
    local input = {
        FloatValue = 0/0,
        Boo = 0/0,
    }
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&FloatValue=NaN&Boo=NaN]])
end)

test("Ec2QuerySupportsInfinityFloatInputs", function()
    local input = {
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&FloatValue=Infinity&Boo=Infinity]])
end)

test("Ec2QuerySupportsNegativeInfinityFloatInputs", function()
    local input = {
        FloatValue = -math.huge,
        Boo = -math.huge,
    }
