...
test("SDKAppliedContentEncoding_ec2Query", function() end) -- SKIP: not implemented

test("SDKAppendsGzipAndIgnoresHttpProvidedEncoding_ec2Query", function() end) -- SKIP: not implemented
