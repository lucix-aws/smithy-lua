...
test("NestedStructures", function()
    local input = {
        Nested = {
        StringArg = "foo",
        OtherArg = true,
    ...
    assert_form_eq(body_str, [[Action=NestedStructures&Version=2020-01-08&Nested.StringArg=foo&Nested.OtherArg=true&Nested.RecursiveArg.StringArg=baz]])
end)
