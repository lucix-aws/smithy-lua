...
test("QueryLists", function()
    ...
    assert_form_eq(body_str, [[Action=QueryLists&Version=2020-01-08&ListArg.member.1=foo&ListArg.member.2=bar&ListArg.member.3=baz&ComplexListArg.member.1.hi=hello&ComplexListArg.member.2.hi=hola]])
end)

test("EmptyQueryLists", function()
    local input = {
        ListArg = {},
    }
    local operation = schema.operation({
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryLists&Version=2020-01-08&ListArg=]])
end)

test("FlattenedQueryLists", function()
    local input = {
        FlattenedListArg = {
        "A",
        "B",
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryLists&Version=2020-01-08&FlattenedListArg.1=A&FlattenedListArg.2=B]])
end)

test("QueryListArgWithXmlNameMember", function()
    local input = {
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryLists&Version=2020-01-08&ListArgWithXmlNameMember.item.1=A&ListArgWithXmlNameMember.item.2=B]])
end)

test("QueryFlattenedListArgWithXmlName", function()
    local input = {
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryLists&Version=2020-01-08&Hi.1=A&Hi.2=B]])
end)

test("QueryNestedStructWithList", function()
    local input = {
        NestedWithList = {
        ListArg = {
        "A",
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryLists&Version=2020-01-08&NestedWithList.ListArg.member.1=A&NestedWithList.ListArg.member.2=B]])
end)
