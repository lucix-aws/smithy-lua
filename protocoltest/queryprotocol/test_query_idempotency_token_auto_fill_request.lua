...
test("QueryProtocolIdempotencyTokenAutoFill", function()
    local input = {}
    ...
    assert_form_eq(body_str, [[Action=QueryIdempotencyTokenAutoFill&Version=2020-01-08&token=00000000-0000-4000-8000-000000000000]])
end)

test("QueryProtocolIdempotencyTokenAutoFillIsSet", function()
    local input = {
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryIdempotencyTokenAutoFill&Version=2020-01-08&token=00000000-0000-4000-8000-000000000123]])
end)
