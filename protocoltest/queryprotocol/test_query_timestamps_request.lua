...
test("QueryTimestampsInput", function()
    local input = {
    ...
    assert_form_eq(body_str, [[Action=QueryTimestamps&Version=2020-01-08&normalFormat=2015-01-25T08%3A00%3A00Z&epochMember=1422172800&epochTarget=1422172800]])
end)
