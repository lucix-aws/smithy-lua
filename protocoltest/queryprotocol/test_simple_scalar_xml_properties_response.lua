...
test("QuerySimpleScalarProperties", function()
    local response = {
        status_code = 200,
        headers = {
...
test("AwsQuerySupportsNaNFloatOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "text/xml",
...
test("AwsQuerySupportsInfinityFloatOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "text/xml",
...
test("AwsQuerySupportsNegativeInfinityFloatOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "text/xml",
