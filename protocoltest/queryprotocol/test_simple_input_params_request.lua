...
test("QuerySimpleInputParamsStrings", function()
    local input = {
        Foo = "val1",
        Bar = "val2",
    }
...
test("QuerySimpleInputParamsStringAndBooleanTrue", function()
    local input = {
        Foo = "val1",
        Baz = true,
    }
...
test("QuerySimpleInputParamsStringsAndBooleanFalse", function()
    local input = {
        Baz = false,
    }
    local operation = schema.operation({
...
test("QuerySimpleInputParamsInteger", function()
    local input = {
        Bam = 10,
    }
    local operation = schema.operation({
...
test("QuerySimpleInputParamsFloat", function()
    local input = {
        Boo = 10.8,
    }
    local operation = schema.operation({
...
test("QuerySimpleInputParamsBlob", function()
    local input = {
        Qux = "value",
    }
    local operation = schema.operation({
...
test("QueryIntEnums", function()
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=SimpleInputParams&Version=2020-01-08&IntegerEnum=1]])
end)

test("AwsQuerySupportsNaNFloatInputs", function()
    local input = {
        FloatValue = 0/0,
        Boo = 0/0,
    }
...
test("AwsQuerySupportsInfinityFloatInputs", function()
    local input = {
...
test("AwsQuerySupportsNegativeInfinityFloatInputs", function()
    local input = {
        FloatValue = -math.huge,
        Boo = -math.huge,
    }
