...
test("SDKAppliedContentEncoding_awsQuery", function() end) -- SKIP: not implemented

test("SDKAppendsGzipAndIgnoresHttpProvidedEncoding_awsQuery", function() end) -- SKIP: not implemented
