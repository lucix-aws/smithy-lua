...
test("QuerySimpleQueryMaps", function()
    local input = {
        MapArg = {
        bar = "Bar",
        foo = "Foo",
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryMaps&Version=2020-01-08&MapArg.entry.1.key=bar&MapArg.entry.1.value=Bar&MapArg.entry.2.key=foo&MapArg.entry.2.value=Foo]])
end)

test("QuerySimpleQueryMapsWithXmlName", function()
    local input = {
        RenamedMapArg = {
        foo = "Foo",
    },
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryMaps&Version=2020-01-08&Foo.entry.1.key=foo&Foo.entry.1.value=Foo]])
end)

test("QueryComplexQueryMaps", function()
    local input = {
        ComplexMapArg = {
        bar = {
        hi = "Bar",
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryMaps&Version=2020-01-08&ComplexMapArg.entry.1.key=bar&ComplexMapArg.entry.1.value.hi=Bar&ComplexMapArg.entry.2.key=foo&ComplexMapArg.entry.2.value.hi=Foo]])
end)

test("QueryEmptyQueryMaps", function()
    local input = {
        MapArg = {},
    }
    local operation = schema.operation({
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryMaps&Version=2020-01-08]])
end)

test("QueryQueryMapWithMemberXmlName", function()
    local input = {
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryMaps&Version=2020-01-08&MapWithXmlMemberName.entry.1.K=bar&MapWithXmlMemberName.entry.1.V=Bar&MapWithXmlMemberName.entry.2.K=foo&MapWithXmlMemberName.entry.2.V=Foo]])
end)

test("QueryFlattenedQueryMaps", function()
    local input = {
        FlattenedMap = {
        bar = "Bar",
        foo = "Foo",
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryMaps&Version=2020-01-08&FlattenedMap.1.key=bar&FlattenedMap.1.value=Bar&FlattenedMap.2.key=foo&FlattenedMap.2.value=Foo]])
end)

test("QueryFlattenedQueryMapsWithXmlName", function()
    local input = {
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryMaps&Version=2020-01-08&Hi.1.K=bar&Hi.1.V=Bar&Hi.2.K=foo&Hi.2.V=Foo]])
end)

test("QueryQueryMapOfLists", function()
    local input = {
        MapOfLists = {
        bar = {
        "C",
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryMaps&Version=2020-01-08&MapOfLists.entry.1.key=bar&MapOfLists.entry.1.value.member.1=C&MapOfLists.entry.1.value.member.2=D&MapOfLists.entry.2.key=foo&MapOfLists.entry.2.value.member.1=A&MapOfLists.entry.2.value.member.2=B]])
end)

test("QueryNestedStructWithMap", function()
    local input = {
        NestedStructWithMap = {
        MapArg = {
        bar = "Bar",
    ...
    assert_header(request, "Content-Type", "application/x-www-form-urlencoded")
    local body_str = read_body(request.body)
    assert_form_eq(body_str, [[Action=QueryMaps&Version=2020-01-08&NestedStructWithMap.MapArg.entry.1.key=bar&NestedStructWithMap.MapArg.entry.1.value=Bar&NestedStructWithMap.MapArg.entry.2.key=foo&NestedStructWithMap.MapArg.entry.2.value=Foo]])
end)
