...
test("DocumentTypeInputWithObject", function()
    local input = {
        stringValue = "string",
        documentValue = {
        foo = "bar",
    ...
    assert_url_path(request.url, "/DocumentType")
...
test("DocumentInputWithString", function()
    local input = {
        stringValue = "string",
        documentValue = "hello",
    }
...
test("DocumentInputWithNumber", function()
    local input = {
        stringValue = "string",
        documentValue = 10,
    }
...
test("DocumentInputWithBoolean", function()
    local input = {
        stringValue = "string",
        documentValue = true,
    }
...
test("DocumentInputWithList", function()
    local input = {
        stringValue = "string",
        documentValue = {
        true,
