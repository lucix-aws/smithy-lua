...
test("RestJsonTimestampFormatHeaders", function()
    local input = {
    ...
    assert_url_path(request.url, "/TimestampFormatHeaders")
    assert_header(request, "X-defaultFormat", "Mon, 16 Dec 2019 23:48:18 GMT")
    assert_header(request, "X-memberDateTime", "2019-12-16T23:48:18Z")
    assert_header(request, "X-memberEpochSeconds", "1576540098")
    assert_header(request, "X-memberHttpDate", "Mon, 16 Dec 2019 23:48:18 GMT")
    assert_header(request, "X-targetDateTime", "2019-12-16T23:48:18Z")
    assert_header(request, "X-targetEpochSeconds", "1576540098")
    assert_header(request, "X-targetHttpDate", "Mon, 16 Dec 2019 23:48:18 GMT")
