...
test("RestJsonSimpleScalarProperties", function()
    local input = {
        foo = "Foo",
        stringValue = "string",
...
test("RestJsonDoesntSerializeNullStructureValues", function()
    local input = {
        stringValue = nil,
    }
    local operation = schema.operation({
...
test("RestJsonSupportsNaNFloatInputs", function()
    local input = {
        floatValue = 0/0,
        doubleValue = 0/0,
    }
...
test("RestJsonSupportsInfinityFloatInputs", function()
    local input = {
...
test("RestJsonSupportsNegativeInfinityFloatInputs", function()
    local input = {
        floatValue = -math.huge,
        doubleValue = -math.huge,
    }
