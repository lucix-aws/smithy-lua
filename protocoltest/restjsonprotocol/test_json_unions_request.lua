...
test("RestJsonSerializeStringUnionValue", function()
    local input = {
        contents = {
        stringValue = "foo",
    },
...
test("RestJsonSerializeBooleanUnionValue", function()
    local input = {
        contents = {
        booleanValue = true,
    },
...
test("RestJsonSerializeNumberUnionValue", function()
    local input = {
        contents = {
        numberValue = 1,
    },
...
test("RestJsonSerializeBlobUnionValue", function()
    local input = {
        contents = {
        blobValue = "foo",
    },
...
test("RestJsonSerializeTimestampUnionValue", function()
    local input = {
        contents = {
...
test("RestJsonSerializeEnumUnionValue", function()
    local input = {
        contents = {
        enumValue = "Foo",
    },
...
test("RestJsonSerializeListUnionValue", function()
    local input = {
        contents = {
        listValue = {
        "foo",
...
test("RestJsonSerializeMapUnionValue", function()
    local input = {
        contents = {
        mapValue = {
        foo = "bar",
...
test("RestJsonSerializeStructureUnionValue", function()
    local input = {
        contents = {
        structureValue = {
        hi = "hello",
...
test("RestJsonSerializeRenamedStructureUnionValue", function()
    local input = {
        contents = {
