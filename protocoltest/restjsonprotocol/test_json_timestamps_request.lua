...
test("RestJsonJsonTimestamps", function()
    local input = {
        normal = 1398796238,
    }
    ...
    assert_url_path(request.url, "/JsonTimestamps")
...
test("RestJsonJsonTimestampsWithDateTimeFormat", function()
    local input = {
        dateTime = 1398796238,
    }
    local operation = schema.operation({
...
test("RestJsonJsonTimestampsWithDateTimeOnTargetFormat", function()
    local input = {
...
test("RestJsonJsonTimestampsWithEpochSecondsFormat", function()
    local input = {
...
test("RestJsonJsonTimestampsWithEpochSecondsOnTargetFormat", function()
    local input = {
...
test("RestJsonJsonTimestampsWithHttpDateFormat", function()
    local input = {
        httpDate = 1398796238,
    }
    local operation = schema.operation({
...
test("RestJsonJsonTimestampsWithHttpDateOnTargetFormat", function()
    local input = {
