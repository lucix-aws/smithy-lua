...
test("RestJsonJsonMaps", function()
    local input = {
        denseStructMap = {
        foo = {
        hi = "there",
    ...
    assert_url_path(request.url, "/JsonMaps")
...
test("RestJsonSerializesZeroValuesInMaps", function()
    local input = {
        denseNumberMap = {
        x = 0,
    },
...
test("RestJsonSerializesDenseSetMap", function()
    local input = {
        denseSetMap = {
        x = {},
        y = {
