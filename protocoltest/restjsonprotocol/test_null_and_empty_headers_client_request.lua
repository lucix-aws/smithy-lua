...
test("RestJsonNullAndEmptyHeaders", function()
    local input = {
        a = nil,
        b = "",
        c = {},
    ...
    assert_url_path(request.url, "/NullAndEmptyHeadersClient")
    assert_header(request, "X-B", "")
    assert_header(request, "X-C", "")
    assert_no_header(request, "X-A")
