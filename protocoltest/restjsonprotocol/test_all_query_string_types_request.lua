...
test("RestJsonAllQueryStringTypes", function()
    local input = {
    ...
    assert_eq(request.method, "GET", "method")
    assert_url_path(request.url, "/AllQueryStringTypesInput")
    assert_query_param(request.url, "String=Hello%20there")
    assert_query_param(request.url, "StringList=a")
    assert_query_param(request.url, "StringList=b")
    assert_query_param(request.url, "StringList=c")
    assert_query_param(request.url, "StringSet=a")
    assert_query_param(request.url, "StringSet=b")
    assert_query_param(request.url, "StringSet=c")
    assert_query_param(request.url, "Byte=1")
    assert_query_param(request.url, "Short=2")
    assert_query_param(request.url, "Integer=3")
    assert_query_param(request.url, "IntegerList=1")
    assert_query_param(request.url, "IntegerList=2")
    assert_query_param(request.url, "IntegerList=3")
    assert_query_param(request.url, "IntegerSet=1")
    assert_query_param(request.url, "IntegerSet=2")
    assert_query_param(request.url, "IntegerSet=3")
    assert_query_param(request.url, "Long=4")
    assert_query_param(request.url, "Float=1.1")
    assert_query_param(request.url, "Double=1.1")
    assert_query_param(request.url, "DoubleList=1.1")
    assert_query_param(request.url, "DoubleList=2.1")
    assert_query_param(request.url, "DoubleList=3.1")
    assert_query_param(request.url, "Boolean=true")
    assert_query_param(request.url, "BooleanList=true")
    assert_query_param(request.url, "BooleanList=false")
    assert_query_param(request.url, "BooleanList=true")
    assert_query_param(request.url, "Timestamp=1970-01-01T00%3A00%3A01Z")
    assert_query_param(request.url, "TimestampList=1970-01-01T00%3A00%3A01Z")
    assert_query_param(request.url, "TimestampList=1970-01-01T00%3A00%3A02Z")
    assert_query_param(request.url, "TimestampList=1970-01-01T00%3A00%3A03Z")
    assert_query_param(request.url, "Enum=Foo")
    assert_query_param(request.url, "EnumList=Foo")
    assert_query_param(request.url, "EnumList=Baz")
    assert_query_param(request.url, "EnumList=Bar")
    assert_query_param(request.url, "IntegerEnum=1")
    assert_query_param(request.url, "IntegerEnumList=1")
    assert_query_param(request.url, "IntegerEnumList=2")
    assert_query_param(request.url, "IntegerEnumList=3")
    local body_str = read_body(request.body)
    assert(body_str == "" or body_str == nil, "expected empty body, got: " .. tostring(body_str))
end)

test("RestJsonQueryStringMap", function()
    local input = {
        queryParamsMapOfStringList = {
    ...
    assert_eq(request.method, "GET", "method")
    assert_url_path(request.url, "/AllQueryStringTypesInput")
    assert_query_param(request.url, "QueryParamsStringKeyA=Foo")
    assert_query_param(request.url, "QueryParamsStringKeyB=Bar")
    local body_str = read_body(request.body)
    assert(body_str == "" or body_str == nil, "expected empty body, got: " .. tostring(body_str))
end)

test("RestJsonQueryStringEscaping", function()
    local input = {
        queryString = " %:/?#[]@!$&'()*+,;=😹",
        queryParamsMapOfStringList = {
        String = {
    ...
    assert_eq(request.method, "GET", "method")
    assert_url_path(request.url, "/AllQueryStringTypesInput")
    assert_query_param(request.url, "String=%20%25%3A%2F%3F%23%5B%5D%40%21%24%26%27%28%29%2A%2B%2C%3B%3D%F0%9F%98%B9")
    local body_str = read_body(request.body)
    assert(body_str == "" or body_str == nil, "expected empty body, got: " .. tostring(body_str))
end)

test("RestJsonSupportsNaNFloatQueryValues", function()
    local input = {
        queryFloat = 0/0,
        queryDouble = 0/0,
        queryParamsMapOfStringList = {
    ...
    assert_eq(request.method, "GET", "method")
    assert_url_path(request.url, "/AllQueryStringTypesInput")
    assert_query_param(request.url, "Float=NaN")
    assert_query_param(request.url, "Double=NaN")
    local body_str = read_body(request.body)
    assert(body_str == "" or body_str == nil, "expected empty body, got: " .. tostring(body_str))
end)

test("RestJsonSupportsInfinityFloatQueryValues", function()
    local input = {
    ...
    assert_eq(request.method, "GET", "method")
    assert_url_path(request.url, "/AllQueryStringTypesInput")
    assert_query_param(request.url, "Float=Infinity")
    assert_query_param(request.url, "Double=Infinity")
    local body_str = read_body(request.body)
    assert(body_str == "" or body_str == nil, "expected empty body, got: " .. tostring(body_str))
end)

test("RestJsonSupportsNegativeInfinityFloatQueryValues", function()
    local input = {
        queryFloat = -math.huge,
        queryDouble = -math.huge,
        queryParamsMapOfStringList = {
...
test("RestJsonZeroAndFalseQueryValues", function()
    local input = {
        queryInteger = 0,
        queryBoolean = false,
        queryParamsMapOfStringList = {
    ...
    assert_eq(request.method, "GET", "method")
    assert_url_path(request.url, "/AllQueryStringTypesInput")
    assert_query_param(request.url, "Integer=0")
    assert_query_param(request.url, "Boolean=false")
    local body_str = read_body(request.body)
    assert(body_str == "" or body_str == nil, "expected empty body, got: " .. tostring(body_str))
end)
