...
test("SDKAppliedContentEncoding_restJson1", function() end) -- SKIP: not implemented

test("SDKAppendedGzipAfterProvidedEncoding_restJson1", function() end) -- SKIP: not implemented
