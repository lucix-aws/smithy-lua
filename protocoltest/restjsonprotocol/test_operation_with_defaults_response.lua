...
test("RestJsonClientPopulatesDefaultsValuesWhenMissingInResponse", function()
    local response = {
        status_code = 200,
        headers = {
...
test("RestJsonClientIgnoresDefaultValuesIfMemberValuesArePresentInResponse", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/json",
