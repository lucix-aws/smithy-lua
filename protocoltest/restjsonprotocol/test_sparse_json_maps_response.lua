...
test("RestJsonDeserializesSparseNullMapValues", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/json",
...
test("RestJsonDeserializesZeroValuesInSparseMaps", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/json",
...
test("RestJsonDeserializesSparseSetMap", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/json",
...
test("RestJsonDeserializesSparseSetMapAndRetainsNull", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/json",
