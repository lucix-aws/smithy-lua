...
test("RestJsonFooErrorUsingXAmznErrorType", function()
    local response = {
        status_code = 500,
        headers = {
    ...
    assert(output == nil, "expected nil output for error response")
    assert(err ~= nil, "expected error")
    assert_eq(err.type, "api", "error type")
    assert(err.code == "FooError" or (err.code and err.code:find("FooError", 1, true)),
        "error code: expected FooError, got: " .. tostring(err.code))
end)

test("RestJsonFooErrorUsingXAmznErrorTypeWithUri", function()
    local response = {
        status_code = 500,
        headers = {
...
test("RestJsonFooErrorUsingXAmznErrorTypeWithUriAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
...
test("RestJsonFooErrorUsingCode", function()
    local response = {
        status_code = 500,
        headers = {
...
test("RestJsonFooErrorUsingCodeAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/json",
...
test("RestJsonFooErrorUsingCodeUriAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/json",
...
test("RestJsonFooErrorWithDunderType", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/json",
...
test("RestJsonFooErrorWithDunderTypeAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/json",
...
test("RestJsonFooErrorWithDunderTypeUriAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/json",
...
test("RestJsonFooErrorWithNestedTypeProperty", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/json",
