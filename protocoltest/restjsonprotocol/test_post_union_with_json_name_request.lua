...
test("PostUnionWithJsonNameRequest1", function()
    local input = {
        value = {
        foo = "hi",
    },
    ...
    assert_url_path(request.url, "/PostUnionWithJsonName")
...
test("PostUnionWithJsonNameRequest2", function()
    local input = {
        value = {
        baz = "hi",
    },
...
test("PostUnionWithJsonNameRequest3", function()
    local input = {
        value = {
        bar = "hi",
    },
