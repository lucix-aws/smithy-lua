...
test("HttpQueryParamsOnlyRequest", function()
    local input = {
        queryMap = {
        a = "b",
        c = "d",
    ...
    assert_url_path(request.url, "/http-query-params-only")
    assert_query_param(request.url, "a=b")
    assert_query_param(request.url, "c=d")
end)

test("HttpQueryParamsOnlyEmptyRequest", function()
    local input = {
        queryMap = {},
    }
    local operation = schema.operation({
