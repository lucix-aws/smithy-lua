...
test("RestJsonQueryIdempotencyTokenAutoFill", function()
    local input = {}
    ...
    assert_url_path(request.url, "/QueryIdempotencyTokenAutoFill")
    assert_query_param(request.url, "token=00000000-0000-4000-8000-000000000000")
    local body_str = read_body(request.body)
    assert(body_str == "" or body_str == nil, "expected empty body, got: " .. tostring(body_str))
end)

test("RestJsonQueryIdempotencyTokenAutoFillIsSet", function()
    local input = {
