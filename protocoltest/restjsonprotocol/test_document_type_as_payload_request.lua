...
test("DocumentTypeAsPayloadInput", function()
    local input = {
        documentValue = {
        foo = "bar",
    },
    ...
    assert_url_path(request.url, "/DocumentTypeAsPayload")
...
test("DocumentTypeAsPayloadInputString", function()
    local input = {
        documentValue = "hello",
    }
    local operation = schema.operation({
