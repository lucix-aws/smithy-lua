...
test("RestJsonClientPopulatesDefaultValuesInInput", function()
    local input = {
        defaults = {},
    }
    ...
    assert_url_path(request.url, "/OperationWithDefaults")
...
test("RestJsonClientSkipsTopLevelDefaultValuesInInput", function()
    local input = {}
    local operation = schema.operation({
        id = shape_id.from("aws.protocoltests.restjson", "OperationWithDefaults"),
        input = types.OperationWithDefaultsInput,
...
test("RestJsonClientUsesExplicitlyProvidedMemberValuesOverDefaults", function()
    local input = {
        defaults = {
        defaultString = "bye",
        defaultBoolean = true,
...
test("RestJsonClientUsesExplicitlyProvidedValuesInTopLevel", function()
    local input = {
        topLevelDefault = "hi",
...
test("RestJsonClientIgnoresNonTopLevelDefaultsOnMembersWithClientOptional", function()
    local input = {
