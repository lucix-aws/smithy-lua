...
test("RestJsonSupportsNaNFloatHeaderOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["X-Double"] = "NaN",
...
test("RestJsonSupportsInfinityFloatHeaderOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["X-Double"] = "Infinity",
...
test("RestJsonSupportsNegativeInfinityFloatHeaderOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["X-Double"] = "-Infinity",
