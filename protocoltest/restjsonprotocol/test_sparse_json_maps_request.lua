...
test("RestJsonSparseJsonMaps", function()
    local input = {
        sparseStructMap = {
        foo = {
        hi = "there",
    ...
    assert_url_path(request.url, "/SparseJsonMaps")
...
test("RestJsonSerializesSparseNullMapValues", function()
    local input = {
        sparseBooleanMap = {
        x = nil,
    },
...
test("RestJsonSerializesZeroValuesInSparseMaps", function()
    local input = {
        sparseNumberMap = {
        x = 0,
    },
...
test("RestJsonSerializesSparseSetMap", function()
    local input = {
        sparseSetMap = {
        x = {},
        y = {
...
test("RestJsonSerializesSparseSetMapAndRetainsNull", function()
    local input = {
        sparseSetMap = {
        x = {},
        y = {
