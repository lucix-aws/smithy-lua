...
test("DocumentOutputString", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/json",
...
test("DocumentOutputNumber", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/json",
...
test("DocumentOutputBoolean", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/json",
...
test("DocumentOutputArray", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/json",
