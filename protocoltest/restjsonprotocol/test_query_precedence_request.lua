...
test("RestJsonQueryPrecedence", function()
    local input = {
        foo = "named",
        baz = {
        bar = "fromMap",
    ...
    assert_url_path(request.url, "/Precedence")
    assert_query_param(request.url, "bar=named")
    assert_query_param(request.url, "qux=alsoFromMap")
