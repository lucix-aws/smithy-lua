...
test("QueryCompatibleRpcV2CborCustomCodeError", function()
    local response = {
        status_code = 400,
        headers = {
        ...
        body = http.string_reader(base64_decode([[uQACZl9fdHlwZXgrYXdzLnByb3RvY29sdGVzdHMucnBjdjJjYm9yI0N1c3RvbUNvZGVFcnJvcmdtZXNzYWdlYkhp]])),
    }
    ...
    assert(err.code == "CustomCodeError" or (err.code and err.code:find("CustomCodeError", 1, true)),
