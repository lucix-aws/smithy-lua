...
test("RpcV2CborMaps", function()
    ...
    assert_url_path(request.url, "/service/RpcV2Protocol/operation/RpcV2CborDenseMaps")
    ...
    assert_cbor_eq(body_str, base64_decode([[oW5kZW5zZVN0cnVjdE1hcKJjZm9voWJoaWV0aGVyZWNiYXqhYmhpY2J5ZQ==]]))
end)

test("RpcV2CborSerializesZeroValuesInMaps", function()
    local input = {
        denseNumberMap = {
        x = 0,
    },
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[om5kZW5zZU51bWJlck1hcKFheABvZGVuc2VCb29sZWFuTWFwoWF49A==]]))
end)

test("RpcV2CborSerializesDenseSetMap", function()
    local input = {
        denseSetMap = {
        x = {},
        y = {
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[oWtkZW5zZVNldE1hcKJheIBheYJhYWFi]]))
end)
