...
test("RpcV2CborSparseJsonMaps", function()
    local response = {
        status_code = 200,
        headers = {
        ...
        body = http.string_reader(base64_decode([[v29zcGFyc2VTdHJ1Y3RNYXC/Y2Zvb79iaGlldGhlcmX/Y2Jher9iaGljYnll////]])),
    }
...
test("RpcV2CborDeserializesNullMapValues", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[v3BzcGFyc2VCb29sZWFuTWFwv2F49v9vc3BhcnNlTnVtYmVyTWFwv2F49v9vc3BhcnNlU3RyaW5nTWFwv2F49v9vc3BhcnNlU3RydWN0TWFwv2F49v//]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "RpcV2CborSparseMaps"),
        input = schema.new({ type = "structure" }),
...
test("RpcV2CborDeserializesSparseSetMap", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[v2xzcGFyc2VTZXRNYXC/YXmfYWFhYv9heJ////8=]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "RpcV2CborSparseMaps"),
        input = schema.new({ type = "structure" }),
...
test("RpcV2CborDeserializesSparseSetMapAndRetainsNull", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[v2xzcGFyc2VTZXRNYXC/YXif/2F5n2FhYWL/YXr2//8=]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "RpcV2CborSparseMaps"),
        input = schema.new({ type = "structure" }),
...
test("RpcV2CborDeserializesZeroValuesInSparseMaps", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[v29zcGFyc2VOdW1iZXJNYXC/YXgA/3BzcGFyc2VCb29sZWFuTWFwv2F49P//]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "RpcV2CborSparseMaps"),
        input = schema.new({ type = "structure" }),
