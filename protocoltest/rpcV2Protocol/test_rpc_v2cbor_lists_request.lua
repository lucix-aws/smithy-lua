...
test("RpcV2CborLists", function()
    ...
    assert_url_path(request.url, "/service/RpcV2Protocol/operation/RpcV2CborLists")
...
test("RpcV2CborListsEmpty", function()
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v2pzdHJpbmdMaXN0n///]]))
end)

test("RpcV2CborListsEmptyUsingDefiniteLength", function()
    local input = {
        stringList = {},
    }
    local operation = schema.operation({
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[oWpzdHJpbmdMaXN0gA==]]))
end)
