...
test("RpcV2CborFloat16Inf", function()
    local response = {
        status_code = 200,
        headers = {
        ...
        body = http.string_reader(base64_decode([[oWV2YWx1Zfl8AA==]])),
    }
...
test("RpcV2CborFloat16NegInf", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[oWV2YWx1Zfn8AA==]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "Float16"),
        input = schema.new({ type = "structure" }),
...
test("RpcV2CborFloat16LSBNaN", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[oWV2YWx1Zfl8AQ==]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "Float16"),
        input = schema.new({ type = "structure" }),
...
test("RpcV2CborFloat16MSBNaN", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[oWV2YWx1Zfl+AA==]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "Float16"),
        input = schema.new({ type = "structure" }),
...
test("RpcV2CborFloat16Subnormal", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[oWV2YWx1ZfkAUA==]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "Float16"),
        input = schema.new({ type = "structure" }),
