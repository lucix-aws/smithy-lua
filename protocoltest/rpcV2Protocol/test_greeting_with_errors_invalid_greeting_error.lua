...
test("RpcV2CborInvalidGreetingError", function()
    local response = {
        status_code = 400,
        headers = {
        ...
        body = http.string_reader(base64_decode([[v2ZfX3R5cGV4LnNtaXRoeS5wcm90b2NvbHRlc3RzLnJwY3YyQ2JvciNJbnZhbGlkR3JlZXRpbmdnTWVzc2FnZWJIaf8=]])),
    }
    ...
    assert(err.code == "InvalidGreeting" or (err.code and err.code:find("InvalidGreeting", 1, true)),
