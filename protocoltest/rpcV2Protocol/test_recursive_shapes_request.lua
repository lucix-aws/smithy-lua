...
test("RpcV2CborRecursiveShapes", function()
    local input = {
        nested = {
        foo = "Foo1",
        nested = {
    ...
    assert_url_path(request.url, "/service/RpcV2Protocol/operation/RecursiveShapes")
    ...
    assert_cbor_eq(body_str, base64_decode([[v2ZuZXN0ZWS/Y2Zvb2RGb28xZm5lc3RlZL9jYmFyZEJhcjFvcmVjdXJzaXZlTWVtYmVyv2Nmb29kRm9vMmZuZXN0ZWS/Y2JhcmRCYXIy//////8=]]))
end)
