...
test("RpcV2CborRecursiveShapes", function()
    local response = {
        ...
        body = http.string_reader(base64_decode([[v2ZuZXN0ZWS/Y2Zvb2RGb28xZm5lc3RlZL9jYmFyZEJhcjFvcmVjdXJzaXZlTWVtYmVyv2Nmb29kRm9vMmZuZXN0ZWS/Y2JhcmRCYXIy//////8=]])),
    }
...
test("RpcV2CborRecursiveShapesUsingDefiniteLength", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[oWZuZXN0ZWSiY2Zvb2RGb28xZm5lc3RlZKJjYmFyZEJhcjFvcmVjdXJzaXZlTWVtYmVyomNmb29kRm9vMmZuZXN0ZWShY2JhcmRCYXIy]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "RecursiveShapes"),
        input = schema.new({ type = "structure" }),
