...
test("RpcV2CborMaps", function()
    local response = {
        ...
        body = http.string_reader(base64_decode([[oW5kZW5zZVN0cnVjdE1hcKJjZm9voWJoaWV0aGVyZWNiYXqhYmhpY2J5ZQ==]])),
    }
...
test("RpcV2CborDeserializesZeroValuesInMaps", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[om5kZW5zZU51bWJlck1hcKFheABvZGVuc2VCb29sZWFuTWFwoWF49A==]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "RpcV2CborDenseMaps"),
        input = schema.new({ type = "structure" }),
...
test("RpcV2CborDeserializesDenseSetMap", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[oWtkZW5zZVNldE1hcKJheIBheYJhYWFi]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "RpcV2CborDenseMaps"),
        input = schema.new({ type = "structure" }),
