...
test("RpcV2CborSparseMapsSerializeNullValues", function()
    local input = {
        sparseStringMap = {
        foo = nil,
    },
    ...
    assert_url_path(request.url, "/service/RpcV2Protocol/operation/SparseNullsOperation")
    ...
    assert_cbor_eq(body_str, base64_decode([[v29zcGFyc2VTdHJpbmdNYXC/Y2Zvb/b//w==]]))
end)

test("RpcV2CborSparseListsSerializeNull", function()
    local input = {
        sparseStringList = {
        nil,
    },
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v3BzcGFyc2VTdHJpbmdMaXN0n/b//w==]]))
end)
