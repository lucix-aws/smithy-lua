...
test("RpcV2CborComplexError", function()
    local response = {
        status_code = 400,
        headers = {
        ...
        body = http.string_reader(base64_decode([[v2ZfX3R5cGV4K3NtaXRoeS5wcm90b2NvbHRlc3RzLnJwY3YyQ2JvciNDb21wbGV4RXJyb3JoVG9wTGV2ZWxpVG9wIGxldmVsZk5lc3RlZL9jRm9vY2Jhcv//]])),
    }
    ...
    assert(err.code == "ComplexError" or (err.code and err.code:find("ComplexError", 1, true)),
        "error code: expected ComplexError, got: " .. tostring(err.code))
end)

test("RpcV2CborEmptyComplexError", function()
    local response = {
        status_code = 400,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[v2ZfX3R5cGV4K3NtaXRoeS5wcm90b2NvbHRlc3RzLnJwY3YyQ2JvciNDb21wbGV4RXJyb3L/]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "GreetingWithErrors"),
        input = schema.new({ type = "structure" }),
