...
test("RpcV2CborSimpleScalarProperties", function()
    ...
    assert_url_path(request.url, "/service/RpcV2Protocol/operation/SimpleScalarProperties")
    assert_header(request, "Accept", "application/cbor")
    assert_header(request, "Content-Type", "application/cbor")
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v2lieXRlVmFsdWUFa2RvdWJsZVZhbHVl+z/+OVgQYk3TcWZhbHNlQm9vbGVhblZhbHVl9GpmbG9hdFZhbHVl+kD0AABsaW50ZWdlclZhbHVlGQEAaWxvbmdWYWx1ZRkmkWpzaG9ydFZhbHVlGSaqa3N0cmluZ1ZhbHVlZnNpbXBsZXB0cnVlQm9vbGVhblZhbHVl9WlibG9iVmFsdWVDZm9v/w==]]))
end)

test("RpcV2CborClientDoesntSerializeNullStructureValues", function()
    local input = {
        stringValue = nil,
    }
    local operation = schema.operation({
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v/8=]]))
end)

test("RpcV2CborSupportsNaNFloatInputs", function()
    local input = {
        doubleValue = 0/0,
        floatValue = 0/0,
    }
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v2tkb3VibGVWYWx1Zft/+AAAAAAAAGpmbG9hdFZhbHVl+n/AAAD/]]))
end)

test("RpcV2CborSupportsInfinityFloatInputs", function()
    local input = {
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v2tkb3VibGVWYWx1Zft/8AAAAAAAAGpmbG9hdFZhbHVl+n+AAAD/]]))
end)

test("RpcV2CborSupportsNegativeInfinityFloatInputs", function()
    local input = {
        doubleValue = -math.huge,
        floatValue = -math.huge,
    }
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v2tkb3VibGVWYWx1Zfv/8AAAAAAAAGpmbG9hdFZhbHVl+v+AAAD/]]))
end)
