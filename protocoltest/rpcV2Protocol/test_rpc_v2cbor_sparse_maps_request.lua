...
test("RpcV2CborSparseMaps", function()
    local input = {
        sparseStructMap = {
        foo = {
        hi = "there",
    ...
    assert_url_path(request.url, "/service/RpcV2Protocol/operation/RpcV2CborSparseMaps")
    ...
    assert_cbor_eq(body_str, base64_decode([[v29zcGFyc2VTdHJ1Y3RNYXC/Y2Zvb79iaGlldGhlcmX/Y2Jher9iaGljYnll////]]))
end)

test("RpcV2CborSerializesNullMapValues", function()
    local input = {
        sparseBooleanMap = {
        x = nil,
    },
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v3BzcGFyc2VCb29sZWFuTWFwv2F49v9vc3BhcnNlTnVtYmVyTWFwv2F49v9vc3BhcnNlU3RyaW5nTWFwv2F49v9vc3BhcnNlU3RydWN0TWFwv2F49v//]]))
end)

test("RpcV2CborSerializesSparseSetMap", function()
    local input = {
        sparseSetMap = {
        x = {},
        y = {
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v2xzcGFyc2VTZXRNYXC/YXif/2F5n2FhYWL///8=]]))
end)

test("RpcV2CborSerializesSparseSetMapAndRetainsNull", function()
    local input = {
        sparseSetMap = {
        x = {},
        y = {
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v2xzcGFyc2VTZXRNYXC/YXif/2F5n2FhYWL/YXr2//8=]]))
end)

test("RpcV2CborSerializesZeroValuesInSparseMaps", function()
    local input = {
        sparseNumberMap = {
        x = 0,
    },
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v29zcGFyc2VOdW1iZXJNYXC/YXgA/3BzcGFyc2VCb29sZWFuTWFwv2F49P//]]))
end)
