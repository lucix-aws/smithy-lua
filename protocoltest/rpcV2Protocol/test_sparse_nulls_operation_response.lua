...
test("RpcV2CborSparseMapsDeserializeNullValues", function()
    local response = {
        status_code = 200,
        headers = {
        ...
        body = http.string_reader(base64_decode([[v29zcGFyc2VTdHJpbmdNYXC/Y2Zvb/b//w==]])),
    }
...
test("RpcV2CborSparseListsDeserializeNull", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/cbor",
        ...
        body = http.string_reader(base64_decode([[v3BzcGFyc2VTdHJpbmdMaXN0n/b//w==]])),
    }
    local operation = schema.operation({
        id = shape_id.from("smithy.protocoltests.rpcv2Cbor", "SparseNullsOperation"),
        input = schema.new({ type = "structure" }),
