...
test("RpcV2CborClientPopulatesDefaultValuesInInput", function() end) -- SKIP: not implemented

test("RpcV2CborClientSkipsTopLevelDefaultValuesInInput", function()
    local input = {}
    ...
    assert_url_path(request.url, "/service/RpcV2Protocol/operation/OperationWithDefaults")
...
test("RpcV2CborClientUsesExplicitlyProvidedMemberValuesOverDefaults", function() end) -- SKIP: not implemented

test("RpcV2CborClientUsesExplicitlyProvidedValuesInTopLevel", function()
    local input = {
        topLevelDefault = "hi",
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v290b3BMZXZlbERlZmF1bHRiaGl0b3RoZXJUb3BMZXZlbERlZmF1bHQA/w==]]))
end)

test("RpcV2CborClientIgnoresNonTopLevelDefaultsOnMembersWithClientOptional", function()
    local input = {
    ...
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    local body_str = read_body(request.body)
    assert_cbor_eq(body_str, base64_decode([[v3ZjbGllbnRPcHRpb25hbERlZmF1bHRzoP8=]]))
end)
