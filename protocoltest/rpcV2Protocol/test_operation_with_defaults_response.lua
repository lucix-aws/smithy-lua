...
test("RpcV2CborClientPopulatesDefaultsValuesWhenMissingInResponse", function() end) -- SKIP: not implemented

test("RpcV2CborClientIgnoresDefaultValuesIfMemberValuesArePresentInResponse", function()
    local response = {
        status_code = 200,
        headers = {
