...
test("NonQueryCompatibleRpcV2CborForbidsQueryModeHeader", function()
    local input = {}
    ...
    assert_url_path(request.url, "/service/NonQueryCompatibleRpcV2Protocol/operation/NonQueryCompatibleOperation")
    assert_header(request, "Accept", "application/cbor")
    assert_header(request, "smithy-protocol", "rpc-v2-cbor")
    assert_no_header(request, "x-amzn-query-mode")
