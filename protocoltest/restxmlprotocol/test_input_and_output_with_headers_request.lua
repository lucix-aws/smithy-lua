...
test("InputAndOutputWithStringHeaders", function()
    local input = {
        headerString = "Hello",
        headerStringList = {
        "a",
...
test("InputAndOutputWithNumericHeaders", function()
    local input = {
        headerByte = 1,
        headerShort = 123,
        headerInteger = 123,
...
test("InputAndOutputWithBooleanHeaders", function()
    local input = {
        headerTrueBool = true,
...
test("InputAndOutputWithTimestampHeaders", function()
    local input = {
        headerTimestampList = {
        1576540098,
        1576540098,
...
test("InputAndOutputWithEnumHeaders", function()
    local input = {
        headerEnum = "Foo",
        headerEnumList = {
        "Foo",
...
test("RestXmlSupportsNaNFloatHeaderInputs", function()
    local input = {
        headerFloat = 0/0,
        headerDouble = 0/0,
    }
...
test("RestXmlSupportsInfinityFloatHeaderInputs", function()
    local input = {
...
test("RestXmlSupportsNegativeInfinityFloatHeaderInputs", function()
    local input = {
        headerFloat = -math.huge,
        headerDouble = -math.huge,
    }
