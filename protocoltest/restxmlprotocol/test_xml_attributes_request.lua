...
test("XmlAttributes", function()
    ...
    assert_url_path(request.url, "/XmlAttributes")
    assert_header(request, "Content-Type", "application/xml")
    local body_str = read_body(request.body)
    assert_xml_eq(body_str, [[<XmlAttributesRequest test="test">
        <foo>hi</foo>
    </XmlAttributesRequest>
    ]])
end)

test("XmlAttributesWithEscaping", function()
    local input = {
        foo = "hi",
        attr = "<test&mock>",
    }
    ...
    assert_header(request, "Content-Type", "application/xml")
    local body_str = read_body(request.body)
    assert_xml_eq(body_str, [[<XmlAttributesRequest test="&lt;test&amp;mock&gt;">
        <foo>hi</foo>
    </XmlAttributesRequest>
    ]])
end)
