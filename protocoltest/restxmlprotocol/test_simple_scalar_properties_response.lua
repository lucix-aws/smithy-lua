...
test("SimpleScalarPropertiesComplexEscapes", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/xml",
...
test("SimpleScalarPropertiesWithXMLPreamble", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/xml",
...
test("RestXmlSupportsNaNFloatOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/xml",
...
test("RestXmlSupportsInfinityFloatOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/xml",
...
test("RestXmlSupportsNegativeInfinityFloatOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["Content-Type"] = "application/xml",
