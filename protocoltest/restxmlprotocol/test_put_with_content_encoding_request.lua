...
test("SDKAppliedContentEncoding_restXml", function() end) -- SKIP: not implemented

test("SDKAppendedGzipAfterProvidedEncoding_restXml", function() end) -- SKIP: not implemented
