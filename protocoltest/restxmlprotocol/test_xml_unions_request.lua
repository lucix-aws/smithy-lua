...
test("XmlUnionsWithStructMember", function()
    local input = {
        unionValue = {
        structValue = {
        stringValue = "string",
...
test("XmlUnionsWithStringMember", function()
    local input = {
        unionValue = {
...
test("XmlUnionsWithBooleanMember", function()
    local input = {
        unionValue = {
        booleanValue = true,
    },
...
test("XmlUnionsWithUnionMember", function()
    local input = {
        unionValue = {
        unionValue = {
        booleanValue = true,
