...
test("RestXmlEndpointTraitWithHostLabelAndHttpBinding", function()
    local input = {
        accountId = "bar",
    }
    ...
    assert_url_path(request.url, "/EndpointWithHostLabelHeaderOperation")
    assert_header(request, "X-Amz-Account-Id", "bar")
