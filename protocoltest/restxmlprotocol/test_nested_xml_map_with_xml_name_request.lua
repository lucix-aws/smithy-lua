...
test("NestedXmlMapWithXmlNameSerializes", function()
    local input = {
    ...
    assert_url_path(request.url, "/NestedXmlMapWithXmlName")
    assert_header(request, "Content-Type", "application/xml")
    local body_str = read_body(request.body)
    assert_xml_eq(body_str, [[    <NestedXmlMapWithXmlNameRequest>
            <nestedXmlMapWithXmlNameMap>
                <entry>
