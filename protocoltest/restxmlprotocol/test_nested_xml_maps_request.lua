...
test("NestedXmlMapRequest", function()
    local input = {
        nestedMap = {
        foo = {
        bar = "Bar",
...
test("FlatNestedXmlMapRequest", function()
    local input = {
        flatNestedMap = {
        foo = {
        bar = "Bar",
