...
test("XmlTimestamps", function()
    ...
    assert_url_path(request.url, "/XmlTimestamps")
    assert_header(request, "Content-Type", "application/xml")
    local body_str = read_body(request.body)
    assert_xml_eq(body_str, [[<XmlTimestampsRequest>
        <normal>2014-04-29T18:30:38Z</normal>
    </XmlTimestampsRequest>
    ]])
end)

test("XmlTimestampsWithDateTimeFormat", function()
    local input = {
        dateTime = 1398796238,
    }
    local operation = schema.operation({
...
test("XmlTimestampsWithDateTimeOnTargetFormat", function()
    local input = {
...
test("XmlTimestampsWithEpochSecondsFormat", function()
    local input = {
...
test("XmlTimestampsWithEpochSecondsOnTargetFormat", function()
    local input = {
...
test("XmlTimestampsWithHttpDateFormat", function()
    local input = {
        httpDate = 1398796238,
    }
    local operation = schema.operation({
...
test("XmlTimestampsWithHttpDateOnTargetFormat", function()
    local input = {
