...
test("RestXmlSupportsNaNFloatHeaderOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["X-Double"] = "NaN",
...
test("RestXmlSupportsInfinityFloatHeaderOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["X-Double"] = "Infinity",
...
test("RestXmlSupportsNegativeInfinityFloatHeaderOutputs", function()
    local response = {
        status_code = 200,
        headers = {
            ["X-Double"] = "-Infinity",
