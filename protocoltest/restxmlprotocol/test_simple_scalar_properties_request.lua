...
test("SimpleScalarProperties", function()
    local input = {
        foo = "Foo",
        stringValue = "string",
    ...
    assert_eq(request.method, "PUT", "method")
    assert_url_path(request.url, "/SimpleScalarProperties")
    assert_header(request, "Content-Type", "application/xml")
    assert_header(request, "X-Foo", "Foo")
    local body_str = read_body(request.body)
    assert_xml_eq(body_str, [[<SimpleScalarPropertiesRequest>
...
test("SimpleScalarPropertiesWithEscapedCharacter", function()
    local input = {
        foo = "Foo",
        stringValue = "<string>",
    }
...
test("SimpleScalarPropertiesWithWhiteSpace", function()
    local input = {
        foo = "Foo",
...
test("SimpleScalarPropertiesPureWhiteSpace", function()
    local input = {
        foo = "Foo",
        stringValue = "   ",
    }
...
test("RestXmlSupportsNaNFloatInputs", function()
    local input = {
        floatValue = 0/0,
        doubleValue = 0/0,
    }
...
test("RestXmlSupportsInfinityFloatInputs", function()
    local input = {
...
test("RestXmlSupportsNegativeInfinityFloatInputs", function()
    local input = {
        floatValue = -math.huge,
        doubleValue = -math.huge,
    }
