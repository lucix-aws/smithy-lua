...
test("AllQueryStringTypes", function()
    local input = {
...
test("RestXmlQueryStringMap", function()
    local input = {
...
test("RestXmlQueryStringEscaping", function()
    local input = {
        queryString = " %:/?#[]@!$&'()*+,;=😹",
    }
    local operation = schema.operation({
...
test("RestXmlSupportsNaNFloatQueryValues", function()
    local input = {
        queryFloat = 0/0,
        queryDouble = 0/0,
    }
...
test("RestXmlSupportsInfinityFloatQueryValues", function()
    local input = {
...
test("RestXmlSupportsNegativeInfinityFloatQueryValues", function()
    local input = {
        queryFloat = -math.huge,
        queryDouble = -math.huge,
    }
...
test("RestXmlZeroAndFalseQueryValues", function()
    local input = {
        queryInteger = 0,
        queryBoolean = false,
    }
