...
test("HttpPrefixHeadersArePresent", function()
    local input = {
        foo = "Foo",
        fooMap = {
        abc = "Abc value",
    ...
    local operation = schema.operation({
        id = shape_id.from("aws.protocoltests.restxml", "HttpPrefixHeaders"),
...
test("HttpPrefixHeadersAreNotPresent", function()
    local input = {
        foo = "Foo",
        fooMap = {},
    }
...
test("HttpPrefixEmptyHeaders", function()
    local input = {
        fooMap = {
        abc = "",
    },
