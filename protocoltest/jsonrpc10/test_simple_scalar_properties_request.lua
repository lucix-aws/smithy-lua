...
test("AwsJson10SupportsNaNFloatInputs", function()
    local input = {
        floatValue = 0/0,
        doubleValue = 0/0,
    }
    ...
    assert_header(request, "X-Amz-Target", "JsonRpc10.SimpleScalarProperties")
...
test("AwsJson10SupportsInfinityFloatInputs", function()
    local input = {
...
test("AwsJson10SupportsNegativeInfinityFloatInputs", function()
    local input = {
        floatValue = -math.huge,
        doubleValue = -math.huge,
    }
