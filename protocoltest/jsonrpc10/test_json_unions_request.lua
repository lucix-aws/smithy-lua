...
test("AwsJson10SerializeStringUnionValue", function()
    local input = {
        contents = {
        stringValue = "foo",
    },
    ...
    assert_header(request, "Content-Type", "application/x-amz-json-1.0")
    assert_header(request, "X-Amz-Target", "JsonRpc10.JsonUnions")
...
test("AwsJson10SerializeBooleanUnionValue", function()
    local input = {
        contents = {
        booleanValue = true,
    },
...
test("AwsJson10SerializeNumberUnionValue", function()
    local input = {
        contents = {
        numberValue = 1,
    },
...
test("AwsJson10SerializeBlobUnionValue", function()
    local input = {
        contents = {
        blobValue = "foo",
    },
...
test("AwsJson10SerializeTimestampUnionValue", function()
    local input = {
        contents = {
...
test("AwsJson10SerializeEnumUnionValue", function()
    local input = {
        contents = {
        enumValue = "Foo",
    },
...
test("AwsJson10SerializeIntEnumUnionValue", function()
    local input = {
        contents = {
        intEnumValue = 1,
    },
...
test("AwsJson10SerializeListUnionValue", function()
    local input = {
        contents = {
        listValue = {
        "foo",
...
test("AwsJson10SerializeMapUnionValue", function()
    local input = {
        contents = {
        mapValue = {
        foo = "bar",
...
test("AwsJson10SerializeStructureUnionValue", function()
    local input = {
        contents = {
        structureValue = {
        hi = "hello",
