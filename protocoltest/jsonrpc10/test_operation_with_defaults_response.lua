...
describe("OperationWithDefaults response", function()
    it("AwsJson10ClientPopulatesDefaultsValuesWhenMissingInResponse", function()
        local response = {
            status_code = 200,
            headers = {
    ...
    it("AwsJson10ClientIgnoresDefaultValuesIfMemberValuesArePresentInResponse", function()
        local response = {
            status_code = 200,
            headers = {
                ["Content-Type"] = "application/x-amz-json-1.0",
