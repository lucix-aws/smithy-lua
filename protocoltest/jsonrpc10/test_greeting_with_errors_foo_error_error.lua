...
test("AwsJson10FooErrorUsingXAmznErrorType", function()
    local response = {
        status_code = 500,
        headers = {
...
test("AwsJson10FooErrorUsingXAmznErrorTypeWithUri", function()
    local response = {
        status_code = 500,
        headers = {
...
test("AwsJson10FooErrorUsingXAmznErrorTypeWithUriAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
...
test("AwsJson10FooErrorUsingCode", function()
    local response = {
        status_code = 500,
        headers = {
...
test("AwsJson10FooErrorUsingCodeAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/x-amz-json-1.0",
...
test("AwsJson10FooErrorUsingCodeUriAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/x-amz-json-1.0",
...
test("AwsJson10FooErrorWithDunderType", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/x-amz-json-1.0",
...
test("AwsJson10FooErrorWithDunderTypeAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/x-amz-json-1.0",
...
test("AwsJson10FooErrorWithDunderTypeUriAndNamespace", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/x-amz-json-1.0",
...
test("AwsJson10FooErrorWithNestedTypeProperty", function()
    local response = {
        status_code = 500,
        headers = {
            ["Content-Type"] = "application/x-amz-json-1.0",
