...
test("AwsJson10ClientPopulatesDefaultValuesInInput", function()
    local input = {
        defaults = {},
    }
...
test("AwsJson10ClientSkipsTopLevelDefaultValuesInInput", function()
    local input = {}
    local operation = schema.operation({
        id = shape_id.from("aws.protocoltests.json10", "OperationWithDefaults"),
        input = types.OperationWithDefaultsInput,
...
test("AwsJson10ClientUsesExplicitlyProvidedMemberValuesOverDefaults", function()
    local input = {
        defaults = {
        defaultString = "bye",
        defaultBoolean = true,
...
test("AwsJson10ClientUsesExplicitlyProvidedValuesInTopLevel", function()
    local input = {
        topLevelDefault = "hi",
...
test("AwsJson10ClientIgnoresNonTopLevelDefaultsOnMembersWithClientOptional", function()
    local input = {
