...
test("SDKAppliedContentEncoding_awsJson1_0", function() end) -- SKIP: not implemented

test("SDKAppendsGzipAndIgnoresHttpProvidedEncoding_awsJson1_0", function() end) -- SKIP: not implemented
