...
describe("NullOperation request", function()
    it("AwsJson11StructuresDontSerializeNullValues", function()
        local input = {
            string = nil,
        }
        local operation = schema.operation({
            id = shape_id.from("aws.protocoltests.json", "NullOperation"),
            input = types.NullOperationInput,
        ...
        h.assert_header(request, "X-Amz-Target", "JsonProtocol.NullOperation")
