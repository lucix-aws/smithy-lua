...
describe("EmptyOperation request", function()
    it("sends_requests_to_slash", function()
        local input = {}
        local operation = schema.operation({
            id = shape_id.from("aws.protocoltests.json", "EmptyOperation"),
            input = types.EmptyOperationInput,
        ...
        h.assert_header(request, "X-Amz-Target", "JsonProtocol.EmptyOperation")
    end)

    it("includes_x_amz_target_and_content_type", function()
        local input = {}
        local operation = schema.operation({
            id = shape_id.from("aws.protocoltests.json", "EmptyOperation"),
            input = types.EmptyOperationInput,
    ...
    it("json_1_1_client_sends_empty_payload_for_no_input_shape", function()
        local input = {}
        local operation = schema.operation({
            id = shape_id.from("aws.protocoltests.json", "EmptyOperation"),
            input = types.EmptyOperationInput,
