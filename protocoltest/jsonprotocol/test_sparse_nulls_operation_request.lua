...
test("AwsJson11SparseMapsSerializeNullValues", function()
    local input = {
        sparseStringMap = {
        foo = nil,
    },
    ...
    assert_header(request, "X-Amz-Target", "JsonProtocol.SparseNullsOperation")
...
test("AwsJson11SparseListsSerializeNull", function()
    local input = {
        sparseStringList = {
        nil,
    },
