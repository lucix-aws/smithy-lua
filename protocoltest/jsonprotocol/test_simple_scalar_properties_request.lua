...
test("AwsJson11SupportsNaNFloatInputs", function()
    local input = {
        floatValue = 0/0,
        doubleValue = 0/0,
    }
    ...
    assert_header(request, "X-Amz-Target", "JsonProtocol.SimpleScalarProperties")
...
test("AwsJson11SupportsInfinityFloatInputs", function()
    local input = {
...
test("AwsJson11SupportsNegativeInfinityFloatInputs", function()
    local input = {
        floatValue = -math.huge,
        doubleValue = -math.huge,
    }
