...
describe("EndpointWithHostLabelOperation request", function()
    it("AwsJson11EndpointTraitWithHostLabel", function()
        local input = {
            label = "bar",
        }
        local operation = schema.operation({
            id = shape_id.from("aws.protocoltests.json", "EndpointWithHostLabelOperation"),
        ...
        h.assert_header(request, "X-Amz-Target", "JsonProtocol.EndpointWithHostLabelOperation")
