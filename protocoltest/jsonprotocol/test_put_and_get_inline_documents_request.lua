...
describe("PutAndGetInlineDocuments request", function()
    it("PutAndGetInlineDocumentsInput", function()
        local input = {
            inlineDocument = {
            foo = "bar",
        },
        ...
        local operation = schema.operation({
            id = shape_id.from("aws.protocoltests.json", "PutAndGetInlineDocuments"),
            input = types.PutAndGetInlineDocumentsInput,
        ...
        h.assert_header(request, "X-Amz-Target", "JsonProtocol.PutAndGetInlineDocuments")
