...
test("SDKAppliedContentEncoding_awsJson1_1", function() end) -- SKIP: not implemented

test("SDKAppendsGzipAndIgnoresHttpProvidedEncoding_awsJson1_1", function() end) -- SKIP: not implemented
