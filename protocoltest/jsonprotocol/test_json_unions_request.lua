...
test("AwsJson11SerializeStringUnionValue", function()
    local input = {
        contents = {
        stringValue = "foo",
    },
    ...
    assert_header(request, "X-Amz-Target", "JsonProtocol.JsonUnions")
...
test("AwsJson11SerializeBooleanUnionValue", function()
    local input = {
        contents = {
        booleanValue = true,
    },
...
test("AwsJson11SerializeNumberUnionValue", function()
    local input = {
        contents = {
        numberValue = 1,
    },
...
test("AwsJson11SerializeBlobUnionValue", function()
    local input = {
        contents = {
        blobValue = "foo",
    },
...
test("AwsJson11SerializeTimestampUnionValue", function()
    local input = {
        contents = {
...
test("AwsJson11SerializeEnumUnionValue", function()
    local input = {
        contents = {
        enumValue = "Foo",
    },
...
test("AwsJson11SerializeListUnionValue", function()
    local input = {
        contents = {
        listValue = {
        "foo",
...
test("AwsJson11SerializeMapUnionValue", function()
    local input = {
        contents = {
        mapValue = {
        foo = "bar",
...
test("AwsJson11SerializeStructureUnionValue", function()
    local input = {
        contents = {
        structureValue = {
        hi = "hello",
