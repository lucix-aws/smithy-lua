-- smithy-lua runtime: Trait key definitions
-- Each trait is a singleton key used to index into a schema's trait table.
-- The value stored at each key is a trait record with typed fields.
--
-- Usage:
--   local t = require("smithy.traits")
--   local jn = schema:trait(t.JSON_NAME)  -- returns { name = "..." } or nil
--   local req = schema:trait(t.REQUIRED)  -- returns {} or nil
