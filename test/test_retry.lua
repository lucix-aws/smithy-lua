...
it("none: retry_token always returns nil + error", function()
    ...
    assert.are.equal("Throttling", err.code)
end)
...
it("standard: non-retryable error returns nil", function()
    ...
    assert.are.equal("ValidationError", retry_err.code)
end)
