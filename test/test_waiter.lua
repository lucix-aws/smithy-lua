...
it("wait: success on first attempt", function()
    ...
    assert.are.equal("ACTIVE", output.Table.TableStatus)
end)
...
it("wait: failure acceptor stops immediately", function()
    ...
    assert.are.equal("WaiterFailure", err.code)
end)
